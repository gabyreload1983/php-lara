                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/" aria-current="page"
                                class="rounded-md px-3 py-2 text-sm font-medium <?= urlIs('/') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">Dashboard</a>
                            <a href="/about"
                                class="rounded-md px-3 py-2 text-sm font-medium <?= urlIs('/about') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">About</a>

                            <?php if (isset($_SESSION['user'])): ?>
                            <a href="/notes"
                                class="rounded-md px-3 py-2 text-sm font-medium <?= urlIs('/notes') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">Notes</a>
                            <?php endif; ?>
                            <a href="/contact"
                                class="rounded-md px-3 py-2 text-sm font-medium <?= urlIs('/contact') ? 'bg-gray-950/50 text-white' : 'text-gray-300 hover:bg-white/5 hover:text-white' ?>">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center gap-2 md:ml-6">
                        ...
                        <form method="POST" action="/session">
                            ...
                            <button
                                class="cursor-pointer rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Logout</button>
                        </form>
                        <?php else: ?>
